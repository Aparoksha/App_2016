 ...
 */
public class Eventlist_Webkriti extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "web";
    private String intentNaam;
    final static private String EVENT_NAME = "Webkriti";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_webkriti);
