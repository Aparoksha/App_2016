 ...
 */
public class Eventlist_HumbleFoolCup extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "hum";
    private String intentNaam;
    final static private String EVENT_NAME = "Humble Fool Cup";
    ...
    private LinearLayout org4;
    private TextView num5;
    private LinearLayout org5;
    private TextView num6;
    private LinearLayout org6;
    private TextView num7;
    private LinearLayout org7;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.event_humblefoolcup);
        toolbar = (Toolbar) findViewById(R.id.anim_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("Humble Fool Cup");
        ...
        org4 = (LinearLayout) findViewById(R.id.organiser4);
        org4.setOnClickListener(this);
        num5 = (TextView) findViewById(R.id.num3);
        org5 = (LinearLayout) findViewById(R.id.organiser5);
        org5.setOnClickListener(this);
        num6 = (TextView) findViewById(R.id.num6);
        org6 = (LinearLayout) findViewById(R.id.organiser6);
        org6.setOnClickListener(this);
        num7 = (TextView) findViewById(R.id.num7);
        org7 = (LinearLayout) findViewById(R.id.organiser7);
        org7.setOnClickListener(this);
        ...
        switch (view.getId())
        {
            ...
            case R.id.organiser3:
               ...
               /* startActivity(callIntent);
                ...
                break;
            case R.id.organiser4:
                String number4 = num3.getText().toString().trim();
                Intent callIntent4 = new Intent(Intent.ACTION_VIEW, Uri.parse("tel:+91"+number4));
               /* startActivity(callIntent);
                Intent callIntent22 = new Intent(Intent.ACTION_CALL);
                callIntent22.setData(Uri.parse("tel:+91" + number2));*/
                if (!hasPermission("android.permission.CALL_PHONE")) {
                ...
                break;
            case R.id.organiser5:
                String number5 = num3.getText().toString().trim();
                Intent callIntent5 = new Intent(Intent.ACTION_VIEW, Uri.parse("tel:+91"+number5));
               /* startActivity(callIntent);
                Intent callIntent22 = new Intent(Intent.ACTION_CALL);
                callIntent22.setData(Uri.parse("tel:+91" + number2));*/
                if (!hasPermission("android.permission.CALL_PHONE")) {
                ...
                break;
            case R.id.organiser6:
                String number6 = num3.getText().toString().trim();
                Intent callIntent6 = new Intent(Intent.ACTION_VIEW, Uri.parse("tel:+91"+number6));
               /* startActivity(callIntent);
                Intent callIntent22 = new Intent(Intent.ACTION_CALL);
                callIntent22.setData(Uri.parse("tel:+91" + number2));*/
                if (!hasPermission("android.permission.CALL_PHONE")) {
                ...
                break;
            case R.id.organiser7:
                String number7 = num7.getText().toString().trim();
                Intent callIntent7 = new Intent(Intent.ACTION_VIEW, Uri.parse("tel:+91"+number7));
               /* startActivity(callIntent);
                Intent callIntent22 = new Intent(Intent.ACTION_CALL);
                callIntent22.setData(Uri.parse("tel:+91" + number2));*/
                if (!hasPermission("android.permission.CALL_PHONE")) {
