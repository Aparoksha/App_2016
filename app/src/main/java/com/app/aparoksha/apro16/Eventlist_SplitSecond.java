 ...
 */
public class Eventlist_SplitSecond extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "spl";
    private String intentNaam;
    final static private String EVENT_NAME = "Split Second";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_splitsecond);
        toolbar = (Toolbar) findViewById(R.id.anim_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("Split Second");
