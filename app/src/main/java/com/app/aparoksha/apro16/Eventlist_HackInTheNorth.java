 ...
 */
public class Eventlist_HackInTheNorth extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "hac";
    private String intentNaam;
    final static private String EVENT_NAME = "Hack In The North";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_hackinthenorth);
