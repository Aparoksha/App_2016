 ...
 */
public class Eventlist_ITQuiz extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "itq";
    private String intentNaam;
    final static private String EVENT_NAME = "IT Quiz";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_itquiz);
