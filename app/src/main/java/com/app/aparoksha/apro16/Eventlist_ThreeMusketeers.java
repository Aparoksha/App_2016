 ...
 */
public class Eventlist_ThreeMusketeers extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "thr";
    private String intentNaam;
    final static private String EVENT_NAME = "Three Muskeeteers";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_threemusketeers);
        toolbar = (Toolbar) findViewById(R.id.anim_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("Three Muskeeteers");
