 ...
 */
public class Eventlist_MRGoogler extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "mrg";
    private String intentNaam;
    final static private String EVENT_NAME = "MR Googler";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_mrgoogler);
        toolbar = (Toolbar) findViewById(R.id.anim_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("MR Googler");
