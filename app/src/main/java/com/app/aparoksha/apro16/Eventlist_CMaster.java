 ...
 */
public class Eventlist_CMaster extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "cma";
    private String intentNaam;
    final static private String EVENT_NAME = "C Master";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_cmaster);
