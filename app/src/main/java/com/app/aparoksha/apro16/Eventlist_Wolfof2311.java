 ...
 */
public class Eventlist_Wolfof2311 extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "wol";
    private String intentNaam;
    final static private String EVENT_NAME = "Wolf of 2311";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_wolfof2311);
        toolbar = (Toolbar) findViewById(R.id.anim_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("Wolf of 2311");
