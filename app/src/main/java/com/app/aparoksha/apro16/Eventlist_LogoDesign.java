 ...
 */
public class Eventlist_LogoDesign extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "log";
    private String intentNaam;
    final static private String EVENT_NAME = "Logo Designing";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_logodesign);
        toolbar = (Toolbar) findViewById(R.id.anim_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("Logo Designing");
