 ...
 */
public class Eventlist_AgeofEmpiresIII extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "age";
    private String intentNaam;
    final static private String EVENT_NAME = "Age of Empires III";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_ageofempiresiii);
        toolbar = (Toolbar) findViewById(R.id.anim_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("Age of Empires III");
