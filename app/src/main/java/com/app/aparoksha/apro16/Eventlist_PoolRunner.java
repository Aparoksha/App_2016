 ...
 */
public class Eventlist_PoolRunner extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "poo";
    private String intentNaam;
    final static private String EVENT_NAME = "Pool Runner";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_poolrunner);
        toolbar = (Toolbar) findViewById(R.id.anim_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("Pool Runner");
