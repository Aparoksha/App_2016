 ...
 */
public class Eventlist_FlappyBird extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "fla";
    private String intentNaam;
    final static private String EVENT_NAME = "Flappy Bird";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_flappybird);
        toolbar = (Toolbar) findViewById(R.id.anim_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("Flappy Bird");
