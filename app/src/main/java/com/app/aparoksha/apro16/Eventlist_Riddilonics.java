 ...
 */
public class Eventlist_Riddilonics extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "rid";
    private String intentNaam;
    final static private String EVENT_NAME = "Riddilonics";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_riddilonics);
        toolbar = (Toolbar) findViewById(R.id.anim_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("Riddilonics");
