 ...
 */
public class Eventlist_Talks extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "tal";
    private String intentNaam;
    final static private String EVENT_NAME = "Talks";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_talks);
        toolbar = (Toolbar) findViewById(R.id.anim_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("Talks");
