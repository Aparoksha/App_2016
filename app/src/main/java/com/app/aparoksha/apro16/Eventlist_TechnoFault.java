 ...
 */
public class Eventlist_TechnoFault extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "tecfa";
    private String intentNaam;
    final static private String EVENT_NAME = "Techno Fault";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_technofault);
        toolbar = (Toolbar) findViewById(R.id.anim_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("Techno Fault");
