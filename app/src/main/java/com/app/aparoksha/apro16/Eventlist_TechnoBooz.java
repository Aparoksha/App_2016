 ...
 */
public class Eventlist_TechnoBooz extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "tecbo";
    private String intentNaam;
    final static private String EVENT_NAME = "Techno Booz";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_technobooz);
        toolbar = (Toolbar) findViewById(R.id.anim_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("Techno Booz");
