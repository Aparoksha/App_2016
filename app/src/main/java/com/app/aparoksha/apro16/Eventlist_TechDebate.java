 ...
 */
public class Eventlist_TechDebate extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "tecde";
    private String intentNaam;
    final static private String EVENT_NAME = "Tech Debate";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        collapsingToolbar.setTitle("Tech Debate");
