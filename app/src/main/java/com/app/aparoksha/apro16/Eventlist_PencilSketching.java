 ...
 */
public class Eventlist_PencilSketching extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "pen";
    private String intentNaam;
    final static private String EVENT_NAME = "Pencil Sketching";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_pencilsketching);
        toolbar = (Toolbar) findViewById(R.id.anim_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("Pencil Sketching");
