 ...
 */
public class Eventlist_QWERTYWars extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "qwe";
    private String intentNaam;
    final static private String EVENT_NAME = "QWERTY Wars";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_qwertywars);
        toolbar = (Toolbar) findViewById(R.id.anim_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("QWERTY Wars");
    ...
    public void onClick(View view) {
        ...
        switch (view.getId())
        {
            ...
            case R.id.organiser4:
                String number4 = num4.getText().toString().trim();
               ...
               /* startActivity(callIntent);
                ...
                break;case R.id.organiser5:
            String number5 = num5.getText().toString().trim();
            ...
            break;case R.id.organiser6:
            String number6 = num6.getText().toString().trim();
