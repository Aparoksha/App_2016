 ...
 */
public class Eventlist_TriHackerCup extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "tri";
    private String intentNaam;
    final static private String EVENT_NAME = "Tri Hacker Cup";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_trihackercup);
        toolbar = (Toolbar) findViewById(R.id.anim_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("Tri Hacker Cup");
