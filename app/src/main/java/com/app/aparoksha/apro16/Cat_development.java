 ...
 */
public class Cat_development extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timing = new String[] {"All day","teri maa ka","kya dekh raha hai","lund lega","chooth ka pyasa","lode ke baal"};

        intents = new String[]{"DES", "DES", "DES", "DES", "DES", "DES" };
