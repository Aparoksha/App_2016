 ...
 */
public class Eventlist_AndroidQuiz extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "and";
    private String intentNaam;
    final static private String EVENT_NAME = "Android Quiz";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_androidquiz);
