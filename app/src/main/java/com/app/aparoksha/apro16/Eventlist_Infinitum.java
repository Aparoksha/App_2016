 ...
 */
public class Eventlist_Infinitum extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "inf";
    private String intentNaam;
    final static private String EVENT_NAME = "Infinitum";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_infinitum);
