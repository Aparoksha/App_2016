 ...
 */
public class Eventlist_Alkhwarizm extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "alk";
    private String intentNaam;
    final static private String EVENT_NAME = "Alkhwarizm";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        collapsingToolbar.setTitle("Alkhwarizm");
