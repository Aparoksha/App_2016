 ...
 */
public class Eventlist_FIFA extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "fif";
    private String intentNaam;
    final static private String EVENT_NAME = "FIFA";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_fifa);
        toolbar = (Toolbar) findViewById(R.id.anim_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("FIFA");
