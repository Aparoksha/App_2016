 ...
 */
public class Eventlist_GITHero extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "git";
    private String intentNaam;
    final static private String EVENT_NAME = "GIT Hero";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_githero);
        toolbar = (Toolbar) findViewById(R.id.anim_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("GIT Hero");
