 ...
 */
public class Eventlist_ExMachina extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "em";
    private String intentNaam;
    final static private String EVENT_NAME = "Ex Machina";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_exmachina);
