 ...
 */
public class Eventlist_Eureka extends AppCompatActivity implements View.OnClickListener{
    ...
    private String FAVSTATUS = "eur";
    private String intentNaam;
    final static private String EVENT_NAME = "Eureka";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.event_eureka);
        toolbar = (Toolbar) findViewById(R.id.anim_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        collapsingToolbar = (CollapsingToolbarLayout) findViewById(R.id.collapsing_toolbar);
        collapsingToolbar.setTitle("Eureka");
