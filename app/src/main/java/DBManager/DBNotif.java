...
public class DBNotif {
    ...
    private static final String DATABASE_NAME = "updates";
    private static final String DATABASE_TABLE = "updatestable";
    ...
    public DBNotif openandwrite() throws SQLException {
